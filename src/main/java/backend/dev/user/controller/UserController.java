...
public class UserController {
    ...
    @PostMapping("/join")
    public ResponseEntity<Void> join(@RequestBody UserJoinDTO userJoinDTO, BindingResult bindingResult) {
    ...
    @PostMapping("/login")
    public ResponseEntity<JwtToken> login(@RequestBody UserLoginDTO userLoginDTO, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
            throw new PublicPlusCustomException(ErrorCode.NOT_EMPTY);
        }
    ...
    public ResponseEntity<JwtToken> resignAccessTokenByHeader(
    ...
    ChangePasswordDTO changePasswordDTO, BindingResult bindingResult) {
        if (bindingResult.hasErrors()) {
